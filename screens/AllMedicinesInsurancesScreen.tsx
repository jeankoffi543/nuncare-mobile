...
type Props = {
  navigation: NativeStackNavigationProp<
    RootStackParamList,
    'AllMedicinesInsurancesScreen'
  >;
};

const AllMedicinesInsurancesScreen: React.FC<Props> = ({ navigation }) => {
    ...
    async (pageNumber: number): Promise<void> => {
      ...
      try {
        ...
        const res = await axios.get<ResponseCollection<MedicineResource>>(
          `${API_URLS.MEDICINES_INSURANCES}${queryParams}`,
        );
      ...
      <GestureDetector gesture={panGesture}>
        <View style={styles.mainContainer}>
          ...
          <View style={styles.container}>
            {/* Pharmacy */}
            <Text style={styles.actualityTitle}>Médicaments assurés</Text>
...
export default AllMedicinesInsurancesScreen;
